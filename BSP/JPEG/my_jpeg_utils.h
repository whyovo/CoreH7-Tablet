...
#ifndef __MY_JPEG_UTILS_H
#define __MY_JPEG_UTILS_H

/* Includes ------------------------------------------------------------------*/
#include "config.h"
#include "my_jpeg_utils_conf.h"
#ifdef JPEG_ENABLE
...
#if (USE_JPEG_DECODER == 1)
HAL_StatusTypeDef
my_JPEG_GetDecodeColorConvertFunc(JPEG_ConfTypeDef *pJpegInfo,
...
#if (USE_JPEG_ENCODER == 1)
HAL_StatusTypeDef
my_JPEG_GetEncodeColorConvertFunc(JPEG_ConfTypeDef *pJpegInfo,
