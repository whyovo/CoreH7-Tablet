 ...
 * (Direction_H/Direction_V/Direction_H_Flip/Direction_V_Flip)
 ...
 * @note   示例：LCD_DisplayChinese(10, 10, "你")
 * @retval None
 */
 ...
 * @param  y 起始垂直坐标
 * @param  pText 字符串首地址
 * @note   示例：LCD_DisplayText(10, 10, "你好123")
 * @retval None
 */
