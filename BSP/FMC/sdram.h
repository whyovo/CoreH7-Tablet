...
#define FMC_COMMAND_TARGET_BANK                                                \
  FMC_SDRAM_CMD_TARGET_BANK1             /*!< SDRAM的Bank选择 */
 ...
 */
uint8_t SDRAM_WriteBuffer_8bit(uint32_t Address, uint8_t *pBuffer,
                               uint32_t Length);
 ...
 */
uint8_t SDRAM_ReadBuffer_8bit(uint32_t Address, uint8_t *pBuffer,
                              uint32_t Length);
 ...
 */
uint8_t SDRAM_WriteBuffer_32bit(uint32_t Address, uint32_t *pBuffer,
                                uint32_t Length);
 ...
 */
uint8_t SDRAM_ReadBuffer_32bit(uint32_t Address, uint32_t *pBuffer,
                               uint32_t Length);
