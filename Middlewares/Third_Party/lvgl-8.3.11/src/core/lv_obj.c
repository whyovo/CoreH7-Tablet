 ...
 **********************/
static void
LV_ATTRIBUTE_FAST_MEM lv_obj_constructor(const lv_obj_class_t *class_p,
                                        lv_obj_t *obj);
static void
LV_ATTRIBUTE_FAST_MEM lv_obj_destructor(const lv_obj_class_t *class_p,
                                       lv_obj_t *obj);
static void LV_ATTRIBUTE_FAST_MEM lv_obj_draw(lv_event_t *e);
static void LV_ATTRIBUTE_FAST_MEM lv_obj_event(const lv_obj_class_t *class_p,
                                              lv_event_t *e);
static void LV_ATTRIBUTE_FAST_MEM draw_scrollbar(lv_obj_t *obj,
                                                lv_draw_ctx_t *draw_ctx);
static lv_res_t
LV_ATTRIBUTE_FAST_MEM scrollbar_init_draw_dsc(lv_obj_t *obj,
                                             lv_draw_rect_dsc_t *dsc);
static bool LV_ATTRIBUTE_FAST_MEM obj_valid_child(const lv_obj_t *parent,
                                                 const lv_obj_t *obj_to_find);
static void LV_ATTRIBUTE_FAST_MEM lv_obj_set_state(lv_obj_t *obj,
